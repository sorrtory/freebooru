...
func TestSettingsNeverExposePathsAndRequireRevision(t *testing.T) {
	app := &fakeApplication{settings: core.Settings{
		...
		DefaultStorageName: "default", HTTPPort: 52800,
	}}
	...
	body := `{"revision":"revision","language":"en","default_collection":"main","default_storage_name":"default","http_port":52801,"remove_on_upload":false}`
	response = httptest.NewRecorder()
