  ...
  <div class="app-shell">
    <header class="app-bar">
      ...
      <nav aria-label="Collection navigation">
        ...
        <RouterLink :to="`/collections/${encodeURIComponent(collection)}/search`"><svg aria-hidden="true" viewBox="0 0 24 24"><circle cx="11" cy="11" r="6"/><path d="m16 16 4 4"/></svg><span>Search</span></RouterLink>
...
nav a { display: flex; min-height: 2.75rem; align-items: center; justify-content: center; gap: .35rem; padding: .35rem .65rem; border-radius: var(--radius); color: var(--text-muted); font-size: .78rem; font-weight: 800; text-decoration: none; }
